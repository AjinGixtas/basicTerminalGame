...
public static class ItemCrafter {
    ...
    public static readonly CraftableItemData[] REFINED_MATERIALS = [
        ...
        new CraftableItemData("RefinedFerrosync"           , "FS&" , 13, Cc.c ,  1.600000,       8, [new(3, 5)]),
    ...
    public static readonly CraftableItemData[] COMPONENTS = [
        ...
        new CraftableItemData("ChainFiber"                 , "CHA^", 24, Cc.r ,  2.942595,      39, [new(12, 1)]),
        ...
        new CraftableItemData("NeuroChip"                  , "NEU^", 31, Cc.G ,  2.608146,      56, [new(14, 1)]),
        ...
        new CraftableItemData("FluxThread"                 , "FLU^", 36, Cc.bG,  2.669393,      68, [new(15, 1)]),
        ...
        new CraftableItemData("AugmentModule"              , "AUG^", 42, Cc.LY,  3.010945,      88, [new(16, 1)]),
        ...
        new CraftableItemData("SysCore"                    , "SYS^", 54, Cc.LC,  2.800820,     136, [new(18, 1)]),
        ...
        new CraftableItemData("ObsidianBit"                , "OBI^", 60, Cc.gR,  3.401000,     169, [new(19, 1)]),
